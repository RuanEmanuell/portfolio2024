...
import ProjectImg10 from '../../images/project9.png';
import ProjectImg11 from '../../images/project10.png';
...
const Projects: React.FC<Props> = ({ projectsRef }) => {
  ...
  const projects = [
    ...
    ['Observatorio IFTM', ProjectImg5, 'Uma versão mobile do Observatório do IFTM, feito em React Native'],
    ['RTChat', ProjectImg6, 'Um chat em tempo real feito com Flutter e Firebase'],
    ['ProgEdu', ProjectImg7, 'Aplicativo para aprender a programar, com ranking online, feito com Flutter e Firebase'],
    ['NativeSocial', ProjectImg8, 'Uma mini rede social feita com React Native, Python (Flask) e SQLite'],
    ['CellMax', ProjectImg9, 'Um comparador e lista de smartphones, feito com Java Spring Boot, React e SQLite'],
    ['ReadmeGenerator', ProjectImg10, 'Gerador de READMEs para projetos do Github, feito com NextJS'],
    ['TodoNode', ProjectImg11, 'Um Todo List web feito com Node, Express e MongoDB'],
  ]
    ...
    <div className='projects' style={{ opacity: projectsOpacity }} ref={projectsRef}>
      <main className='container'>
        ...
        <article>
          ...
          <a href='https://github.com/RuanEmanuell' target="_blank" className='githubButton'>
